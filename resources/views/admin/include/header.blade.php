            ...
            <div class="sidebar-inner slimscrollleft">
                ...
                <div id="sidebar-menu">
                    <ul>
                        ...
                        <li>
                            <a href="{{ route('admin.whatwedo.index') }}" class="waves-effect">
                                <i class="mdi mdi-lightbulb"></i> <span> What We Do </span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('admin.about_us.index') }}" class="waves-effect">
                                <i class="mdi mdi-view-dashboard"></i> <span> About Us </span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('admin.blog.index') }}" class="waves-effect">
                                <i class="mdi mdi-view-dashboard"></i> <span> Blog </span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('admin.team.index') }}" class="waves-effect">
                                <i class="mdi mdi-view-dashboard"></i> <span> Team </span>
                            </a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="{{ route('admin.contact.list') }}" class="waves-effect">
                                <i class="mdi mdi-view-dashboard"></i> <span> Contact </span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('admin.change_password_form') }}" class="waves-effect"><i
                                    class="mdi mdi-key"></i> <span> Change Password </span> </a>
                        </li>

                        <li>
                            <a href="#"
                                onclick="event.preventDefault();document.getElementById('logout-form').submit();"
                                class="waves-effect"><i class="mdi mdi-lock-outline"></i>
                                <span>Logout </span>
